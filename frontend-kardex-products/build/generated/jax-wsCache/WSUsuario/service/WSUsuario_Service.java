 ...
 * 
 */
@WebServiceClient(name = "WSUsuario", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8080/Backend-ParcialFinalProgramacionIII/WSUsuario?WSDL")
    ...
    extends Service
{
    ...
    private final static QName WSUSUARIO_QNAME = new QName("http://service/", "WSUsuario");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Backend-ParcialFinalProgramacionIII/WSUsuario?WSDL");
    ...
    public WSUsuario getWSUsuarioPort() {
        return super.getPort(new QName("http://service/", "WSUsuarioPort"), WSUsuario.class);
    }
    ...
    public WSUsuario getWSUsuarioPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "WSUsuarioPort"), WSUsuario.class, features);
    }
